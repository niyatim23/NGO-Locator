...
<?php
 ...
 {  
      ...
      $result = mysqli_query($connect, "SELECT name,address FROM ngoogle.ngo WHERE type=1");  
      $output .= '  
...
";
                $result = mysqli_query($connect, "SELECT name,address,email,pin_code FROM ngoogle.ngo WHERE type=1");  
...
";
            ...
            $result = mysqli_query($connect, "SELECT email FROM ngoogle.ngo WHERE type=1");
...
Hello!
Our User ".$user_row["fname"]." ".$user_row["lname"]." wants to donate food to your NGO.
