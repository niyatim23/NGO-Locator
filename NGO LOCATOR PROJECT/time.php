...
<?php
 ...
 {  
      ...
      $result = mysqli_query($connect, "SELECT name,address FROM ngoogle.ngo WHERE type=3");  
      $output .= '  
...
";
                $result = mysqli_query($connect, "SELECT name,address,email,pin_code FROM ngoogle.ngo WHERE type=3");  
...
";
      ...
      $result = mysqli_query($connect, "SELECT email FROM ngoogle.ngo WHERE type=3");
...
Hello!
Our User ".$user_row["fname"]." ".$user_row["lname"]." wants to donate time i.e. work as a volunteer for your NGO.
