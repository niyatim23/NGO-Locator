...
<?php
 ...
 {  
      ...
      $result = mysqli_query($connect, "SELECT name,address FROM ngoogle.ngo WHERE type=6");  
      $output .= '  
...
";
                $result = mysqli_query($connect, "SELECT name,address,email,pin_code FROM ngoogle.ngo WHERE type=6");  
...
";
            ...
            $result = mysqli_query($connect, "SELECT email FROM ngoogle.ngo WHERE type=6");
...
Hello!
Our User ".$user_row["fname"]." ".$user_row["lname"]." wants to donate medical equipment to your NGO.
